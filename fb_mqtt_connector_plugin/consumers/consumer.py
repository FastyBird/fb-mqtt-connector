...
"""
FastyBird MQTT connector plugin consumers module proxy
"""
...
# Library libs
from fb_mqtt_connector_plugin.consumers.entities import BaseEntity
from fb_mqtt_connector_plugin.exceptions import InvalidStateException
