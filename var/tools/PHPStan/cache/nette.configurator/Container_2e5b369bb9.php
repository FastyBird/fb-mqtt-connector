...
// source: /Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/tools/phpstan.tests.neon
// source: array
...
class Container_2e5b369bb9 extends _PHPStan_76bd347d2\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'bootstrapFiles' => [
				...
				'/Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/tools/phpstan-bootstrap.php',
			],
			'excludes_analyse' => [],
			'excludePaths' => null,
			'level' => 'max',
			...
			'mixinExcludeClasses' => [],
			'scanFiles' => [],
			'scanDirectories' => ['/Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/src'],
			'parallel' => [
				'jobSize' => 20,
			...
			'resultCachePath' => '/Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/var/tools/PHPStan/resultCache.tests.php',
			...
			'additionalConfigFiles' => [
				...
				'/Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/tools/phpstan.tests.neon',
			],
	...
	public function createService042(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2e5b369bb9 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/var/tools/PHPStan/resultCache.tests.php',
					...
					[],
					['/Users/akadlec/Development/FastyBird/connectors/fb-mqtt-connector/src'],
					$fileReplacements,
					false
				);
			}
	...
	public function createServiceContainer(): Container_2e5b369bb9
	{
		return $this;
	}
