...
class Container_fabdfd09cd extends _PHPStan_76bd347d2\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService042(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_fabdfd09cd $container)
			{
	...
	public function createServiceContainer(): Container_fabdfd09cd
	{
		return $this;
	}
