...
final class ConnectorFactory implements DevicesModuleConnectors\IConnectorFactory
{
	...
	{
		return Entities\FbMqttConnectorEntity::CONNECTOR_TYPE;
	}
	...
	public function create(
		...
		$version = $this->connectorHelper->getConfiguration(
			$connector->getId(),
			Types\ConnectorPropertyIdentifierType::get(Types\ConnectorPropertyIdentifierType::IDENTIFIER_PROTOCOL_VERSION)
		);
